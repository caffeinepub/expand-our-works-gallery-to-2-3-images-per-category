        ...
        extend: {
            ...
            colors: {
                navy: {
                    ...
                    'card-hover': 'oklch(var(--navy-card-hover))',
                },
                'brand-green': {
                    DEFAULT: 'oklch(var(--brand-green))',
                    dark: 'oklch(var(--brand-green-dark))',
                },
                'whatsapp-green': {
                    DEFAULT: 'oklch(var(--whatsapp-green))',
                    dark: 'oklch(var(--whatsapp-green-dark))',
                },
                'light-gray': 'oklch(var(--light-gray))',
